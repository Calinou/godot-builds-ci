...
cp "$GODOT_DIR/bin"/godot.linuxbsd.* "$ARTIFACTS_DIR/templates/linux_x11_64_${target}"
mv "$GODOT_DIR/bin"/godot.linuxbsd.* "$ARTIFACTS_DIR/templates/linux_x11_32_${target}"
