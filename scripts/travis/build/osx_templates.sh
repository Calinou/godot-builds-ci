...
mv "bin/godot.osx.opt.debug.64" "osx_template.app/Contents/MacOS/godot_osx_debug"
mv "bin/godot.osx.opt.64" "osx_template.app/Contents/MacOS/godot_osx_release"
